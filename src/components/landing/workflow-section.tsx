                    ...
                    <div className="space-y-2">
                        {steps.map((step, i) => (
                            <button
                                ...
                                className={`w-full group relative flex items-start gap-4 p-4 rounded-md border text-left transition-all duration-200 ${activeStep === i
                            ...
                            >
                                <div
                                    className={`p-2 rounded-md border ${activeStep === i

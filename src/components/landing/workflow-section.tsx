...
export function WorkflowSection(): React.ReactElement {
  ...
  return (
    <section className="relative py-14 border-t border-border">
      <div className="container overflow-hidden">
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-8 items-start">
            ...
            {steps.map((step, i) => (
              <button
                ...
                className={`w-full group relative flex items-start gap-4 p-4 rounded-md border text-left transition-all duration-200 ${
                  activeStep === i
                    ? "bg-fd-accent border-fd-primary/30 ring-1 ring-fd-primary/10"
                    : "bg-transparent border-border hover:bg-fd-accent/50 hover:border-fd-muted-foreground/20"
                }`}
              >
                <div
                  className={`p-2 rounded-md border ${
                    activeStep === i
                      ...
                      : "bg-fd-accent/50 text-fd-muted-foreground border-border"
                  }`}
                >
          ...
          <div className="relative">
            <div className="relative rounded-md border border-border bg-fd-card/50 dark:bg-black/60 backdrop-blur-xl overflow-hidden shadow-sm">
              <div className="flex items-center gap-2 px-4 py-2 bg-fd-accent/30 border-b border-border">
                <div className="flex gap-1.5">
                  <div className="w-2 h-2 rounded-full bg-fd-foreground/5 border border-border" />
                  <div className="w-2 h-2 rounded-full bg-fd-foreground/5 border border-border" />
                  <div className="w-2 h-2 rounded-full bg-fd-foreground/5 border border-border" />
                </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <code className="text-fd-foreground/80 dark:text-slate-300 block font-bold dark:font-normal">

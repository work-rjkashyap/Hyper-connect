    ...
    return (
      ...
      >
        ...
        <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
          Make sure other devices on this network have{" "}
          <span className="text-primary font-bold">Hyper-Connect</span> open and
          discovery enabled.
        </p>
        <motion.div
          animate={{ x: [-10, 10, -10] }}
              ...
              >
                ...
                <div className="flex-1 min-w-0 pt-0.5">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant="secondary"
                      className="text-[9px] h-5 px-2 font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-none shadow-none"
                    >
                    ...
                    {device.platform && (
                      <Badge
                        variant="outline"
                        className="text-[9px] h-5 px-2 font-bold uppercase tracking-wider border-border/50 text-muted-foreground"
                      >
                        {device.platform}
                      </Badge>
                    )}

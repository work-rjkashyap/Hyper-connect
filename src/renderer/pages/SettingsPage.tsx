...
export const SettingsPage: React.FC = () => {
    ...
    const handleUpdateProfile = async (): Promise<void> => {
        if ((!name.trim() || name === localDevice?.displayName) && profileImage === localDevice?.profileImage) return
        setSaving(true)
        try {
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            disabled={saving || (name === localDevice?.displayName && profileImage === localDevice?.profileImage)}
                                            variant="default"
                                            size="default"
                                        >

                ...
                <section className="relative pt-28 pb-14 border-b border-border">
                    <div className="container max-w-5xl">
                        ...
                        <p className="text-sm text-fd-muted-foreground font-medium max-w-lg leading-relaxed">
                            Engineering insights, product updates, and
                            behind-the-scenes from building Hyper Connect.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            {blogPosts.map((post, idx) => (
                                <Link
                                    key={post.slug}
                                    href={`/blog/${post.slug}`}
                                    className={`blog-card group block rounded-lg border border-border bg-fd-card/50 dark:bg-fd-card/30 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-fd-primary/30 hover:shadow-xl hover:shadow-fd-primary/5 hover:-translate-y-1 ${idx === 0
                                        ? "md:col-span-3"
                                        : ""
                                        }`}
                                    style={{
                                ...
                                >
                                    {/* Cover Image */}
                                    <div
                                        className={`blog-card-image relative overflow-hidden ${idx === 0
                                            ? "h-52 md:h-64"
                                            : "h-44"
                                            }`}
                                    >
                                    ...
                                    <div className="blog-card-content p-5">
                                        <h2
                                            className={`font-bold text-fd-foreground tracking-tight mb-2 group-hover:text-fd-primary transition-colors duration-300 ${idx === 0
                                                ? "text-lg"
                                                : "text-sm"
                                                }`}
                                        >
